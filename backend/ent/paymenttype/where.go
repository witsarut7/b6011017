...
func TYPE(v string) predicate.Paymenttype {
	return predicate.Paymenttype(func(s *sql.Selector) {
...
func TYPEEQ(v string) predicate.Paymenttype {
	return predicate.Paymenttype(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldTYPE), v))
	})
}
...
func TYPENEQ(v string) predicate.Paymenttype {
	return predicate.Paymenttype(func(s *sql.Selector) {
...
func TYPEIn(vs ...string) predicate.Paymenttype {
...
func TYPENotIn(vs ...string) predicate.Paymenttype {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func TYPEGT(v string) predicate.Paymenttype {
	return predicate.Paymenttype(func(s *sql.Selector) {
...
func TYPEGTE(v string) predicate.Paymenttype {
	return predicate.Paymenttype(func(s *sql.Selector) {
...
func TYPELT(v string) predicate.Paymenttype {
	return predicate.Paymenttype(func(s *sql.Selector) {
...
func TYPELTE(v string) predicate.Paymenttype {
	return predicate.Paymenttype(func(s *sql.Selector) {
...
func TYPEContains(v string) predicate.Paymenttype {
	return predicate.Paymenttype(func(s *sql.Selector) {
...
func TYPEHasPrefix(v string) predicate.Paymenttype {
	return predicate.Paymenttype(func(s *sql.Selector) {
...
func TYPEHasSuffix(v string) predicate.Paymenttype {
	return predicate.Paymenttype(func(s *sql.Selector) {
...
func TYPEEqualFold(v string) predicate.Paymenttype {
	return predicate.Paymenttype(func(s *sql.Selector) {
...
func TYPEContainsFold(v string) predicate.Paymenttype {
	return predicate.Paymenttype(func(s *sql.Selector) {
...
func HasPayment() predicate.Paymenttype {
	return predicate.Paymenttype(func(s *sql.Selector) {
...
func HasPaymentWith(preds ...predicate.Payment) predicate.Paymenttype {
	return predicate.Paymenttype(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
